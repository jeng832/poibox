package com.github.jeng832.exception;

public class ExceptionMessages {

    public static final String EXCEL_CONVERT_EXCEPTION_FILE_PATH_NOT_EXIST = "The excel file path is not exist";
    public static final String EXCEL_CONVERT_EXCEPTION_SHEET_NOT_EXIST = "The sheet name is not exist";
